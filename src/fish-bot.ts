...
class HaxballRoom {
  ...
  private lastBallKicker: PlayerObject | null = null;
...
const interactPlayers: InteractPlayer[] = [
  ...
  },
  {
    ...
    greetings: [
      "Le petit cowboy vient d'entrer dans la room ! 🤠",
  ...
  },
  {
    ...
    greetings: [
      "Le boule le plus charpenté de l'histoire est parmi nous ! 🍑💪",
      "Belle intuition, FOUTRE!",
    ]
  },
  {
    id: 'pat',
